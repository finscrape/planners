...
class WandsworthSpider(scrapy.Spider):
    name = "wandsworth"
    ...
    def parse(self,response):
        ...
        for d in dates_strx[0:-1]:
            ...
            self.driver.get("https://planning.wandsworth.gov.uk/Northgate/PlanningExplorer/GeneralSearch.aspx")
            sleep(3)
        ...
        self.drivera.get("https://planning.wandsworth.gov.uk/Northgate/PlanningExplorer/GeneralSearch.aspx")
        sleep(2)
        ...
        for i in self.listhref:
            ...
            abs_i = f'https://planning.wandsworth.gov.uk/Northgate/PlanningExplorer/Generic/{newi}'
            ...
            for a in olinks:
                if 'http' not in a:
                    abs_a = f'https://planning.wandsworth.gov.uk/Northgate/PlanningExplorer/Generic/{a}'
