...
class AshfordboroughcouncilSpider(scrapy.Spider):
    name = "ashfordboroughcouncil"
    ...
    def parse(self,response):
        ...
        for d in dates_str[0:-1]:
            ...
            self.driver.get("https://ashfordboroughcouncil.my.site.com/pr/s/register-view?c__q=&c__r=Arcus_BE_Public_Register")
            ...
            sleep(3)
            #date picker
            fromDate = self.driver.find_element("xpath","//label[text()='Date Valid From']/following-sibling::div/input")

            fromDate.clear()

            fromDate.send_keys(fd)

            fromto = self.driver.find_element("xpath","//label[text()='Date Valid To']/following-sibling::div/input")
            fromto.clear()
        ...
        for i in self.listhref:
            ...
            abs_i = f'https://ashfordboroughcouncil.my.site.com{i}&tabset-9095e=3'
            if abs_i not in done_url:
                ...
                if each:
                    nei_doc = []
                    rd = htmla.xpath("(//table[@class='pr-table'])[2]/descendant::tr[@class='pr-table__row']")
                    for i in rd[1:]:
                        e_rel={}
