...
class CharnwoodSpider(scrapy.Spider):
    name = "charnwood"
    ...
    def parse(self,response):
        ...
        for d in dates_str5[0:-1]:
            ...
            self.driver.get("https://portal.charnwood.gov.uk/Northgate/PlanningExplorerAA/GeneralSearch.aspx")
            sleep(3)
        ...
        self.drivera.get("https://portal.charnwood.gov.uk/Northgate/PlanningExplorerAA/GeneralSearch.aspx")
        sleep(2)
        ...
        for i in self.listhref:
            ...
            abs_i = f'https://portal.charnwood.gov.uk/Northgate/PlanningExplorerAA/Generic/{newi}'
            ...
            for a in olinks:
                if 'http' not in a:
                    abs_a = f'https://portal.charnwood.gov.uk/Northgate/PlanningExplorerAA/Generic/{a}'
            ...
            if doclinks:
                ...
                for i in rd[1:]:
                    ...
                    e_rel['siteAddress'] = stripper(i.xpath(".//td[7]/descendant::text()").get())
