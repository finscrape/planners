...
class WelhatSpider(scrapy.Spider):
    name = "welhat"
    ...
    def last(self,response):
        ...
        box9 = response.xpath("(//div[@class='icmform'])[9]/table/descendant::tr")
        ...
        if box5:
            for i in box5[2:]:
                ...
                if l:
                    e_rel['fileLink'] = 'https://planning.welhat.gov.uk' + l
        ...
        #nmas
        hd = box9.xpath(".//th/descendant::text()").getall()
        hd = [camel_case(i) for i in hd]
        nma_doc = []
        if box9:
            for i in box9:
