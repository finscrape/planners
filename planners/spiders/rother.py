...
class RotherSpider(scrapy.Spider):
    name = "rother"
    ...
    def parse(self,response):
        ...
        for d in dates_strxx[0:-1]:
            ...
            try:
                self.driver.get("https://planweb01.rother.gov.uk/OcellaWeb/planningSearch")
            except:
                try:
        ...
        for i in self.listhref:
                ...
                abs_i = f'https://planweb01.rother.gov.uk/OcellaWeb/{i}'
                        ...
                        if chlink:
                            ...
                            for i in rd:
                                ...
                                if li:
                                    ...
                                    e_rel['documentTitle'] = stripper(i.xpath(".//td[5]/descendant::text()").get())
