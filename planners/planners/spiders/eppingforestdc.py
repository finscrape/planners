...
class EppingforestdcSpider(scrapy.Spider):
    name = "eppingforestdc"
    ...
    def parse(self,response):
        ...
        for d in dates_str4[0:-1]:
            ...
            self.driver.get("https://eppingforestdc.my.site.com/pr/s/register-view?c__q=&c__r=Arcus_BE_Public_Register")
        ...
        for i in self.listhref:
            ...
            abs_i = f'https://eppingforestdc.my.site.com{i}'
